...
const Booking = () => {
  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <div className='flex justify-center items-center font-semibold text-3xl sm:text-4xl lg:text-5xl mt-4 sm:mt-8 mb-4 sm:mb-8'>
        Cart
      </div>
      
      <div className='flex flex-col justify-center items-center w-full'>
        <div className="mb-4 w-full px-4 sm:px-8 lg:px-0">
          <ul
            className="flex flex-row gap-10 sm:gap-12 text-sm font-medium text-center justify-center"
            id="default-tab"
            role="tablist"
          >
            <li className="w-full sm:w-auto ]" role="presentation">
              <div
                className={`inline-block p-2 sm:p-4 border-b-2 rounded-t-lg ${ 
                 (activeTab === 'Shopping cart' || isCheckedOut) ? (isCheckedOut ? 'border-green-500 sm:text-[10px] lg:text-sm' : 'border-black text-black') : 'text-gray-600 border-gray-300'
                }`}
                type="button"
                role="tab"
                aria-selected={activeTab === 'Shopping cart'}
              >
                <div className='flex gap-2 items-center justify-center sm:justify-start '>
                    ...
                    <div className={`${isCheckedOut ? 'text-green-500 text-[17px]':''}  text-sm sm:text[10px]`}>
                      Shopping cart
                    </div>
                </div>
              </div>
        ...
        <div id="default-tab-content" className="w-full px-2 sm:px-2 lg:px-0">
          <div className={`${activeTab === 'Shopping cart' ? 'block' : 'hidden'}`} id="profile" role="tabpanel">
            <ShoppingCart onCheckout={handleCheckout} setActiveTab={setActiveTab} />
          </div>
          <div className={`${activeTab === 'Checkout details' ? 'block' : 'hidden'}`} id="dashboard" role="tabpanel">
            <CheckoutDetails onPlace={handlePlaceOrder} setActiveTab={setActiveTab} />
          </div>
          <div className={`${activeTab === 'Order complete' ? 'block' : 'hidden'}`} id="settings" role="tabpanel">
            <OrderDetails />
          </div>
        </div>
      </div>
