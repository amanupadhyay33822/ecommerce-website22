  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-8 justify-between max-w-7xl mx-auto">
                  ...
                  <tr key={product._id} className="border-b">
                    <td className="py-4 flex space-x-4 items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Color: {product.product.color}</p>
                        <button className="text-sm text-gray-500 flex gap-2 items-center" onClick={() => handleRemove(product._id)}>
                          <IoCloseSharp className="text-2xl" /> Remove
                        </button>
                      </div>
                    </td>
                    <td>
        ...
        {/* Cart Summary */}
        <div className="w-full lg:w-1/3 border-2 border-black p-4 rounded-lg">
          <h3 className="text-xl font-semibold mb-4">Cart Summary</h3>
          <div className="space-y-3 mb-4">
            <div className="flex items-center justify-between border rounded-lg p-2 cursor-pointer" onClick={() => handleShippingChange(0)}>
              <label>
      ...
      {/* Coupon Section */}
      <div className='flex flex-col gap-1 mb-8 max-w-xs mx-auto'>
        <div className='font-semibold'>Have a Coupon?</div>
        <div className='text-[12px]'>Add your Code for an instant cart discount</div>
        <div className='flex gap-3 mt-3 border-1 border-black px-1 py-2'>
          <CiDiscount1 style={{ fontSize: '24px' }} />
          <input type="text" className='border-none outline-none bg-transparent w-full' placeholder='Coupon Code' />
          <div className='font-semibold'>Apply</div>
        </div>
      </div>
    </div>
